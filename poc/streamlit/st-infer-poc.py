'''
copy from poc-sa-app.py (11.10.2024)
this is still a POC program, if work as expected, it will be implemented in actual program \
as main branch/ beta version of final deliverables.
'''
...
def call_api(text_input):
    try:
        ...
        #change to port 8000 for actual endpoint test (LLM inference with RAG)
